...
import Header from "./WebinarContent/Header";
...
const Webinars = ({ mobileFilter }) => {
  ...
  if (!displayPage || !filteredWebinars) {
    return <Loader />;
  }
  ...
  return (
    <div>
      ...
      <Header mobileFilter={mobileFilter} />
      <div className={webinarPageStyles.main}>
        <div className={webinarPageStyles.showcaseWrapper}>
